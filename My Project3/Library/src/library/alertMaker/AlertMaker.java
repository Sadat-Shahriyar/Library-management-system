...
public class AlertMaker {
    ...
    public static void showTrayMessage(String title, String message) {
        try {
            ...
            BufferedImage image = ImageIO.read(AlertMaker.class.getResource(LibraryUtil.ICON_IMAGE_LOC));
            TrayIcon trayIcon = new TrayIcon(image, "Library");
            trayIcon.setImageAutoSize(true);
            trayIcon.setToolTip("Library");
            tray.add(trayIcon);
